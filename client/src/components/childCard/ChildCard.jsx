...
const ChildCard = () => {
  ...
  const [countFiles, setCountFiles] = useState(selected);
  const [modal, setModal] = useState(false);

  const handleChange = (e, id) => {
    setFiles([e.target.value]);
    setSelected((id) => e.target.value !== id);
    setCountFiles((countFiles) => countFiles + 1);
  };
      ...
      <div className="wrapper">
        ...
        <div className="center">
          <div className="centerLeft">
            <FaLayerGroup className="centerIcon" />
            <p>Lorem ipsum dotor sit amet cum...</p>
          </div>
          <div className="centerRight">
            <FaClipboardList className="centerIcon" />
            <p>1/2</p>
          </div>
        </div>
        <div className="bottom">
          <img
            src="https://www.choosingtherapy.com/wp-content/uploads/2021/11/Dr-Tanveer-Ahmed.jpg"
            alt=""
          />
          <img
            src="https://www.choosingtherapy.com/wp-content/uploads/2021/11/Dr-Tanveer-Ahmed.jpg"
          ...
          <div>
            <LuMessagesSquare className="icons" />
            <p>15</p>
          </div>
          <div>
            <label>
              ...
              <ImAttachment
                onClick={handleModal}
                className="icons attachFileIcon"
              />
              {modal ? (
                <button className="uploadModal" onClick={handleClick}>
                  Upload
                </button>
              ) : (
